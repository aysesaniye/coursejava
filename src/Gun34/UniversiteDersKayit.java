...
public class UniversiteDersKayit {
    ...
    public static void main(String[] args) {
        ...
        Gun34.tasks.task1.Lesson mat101= Gun34.tasks.task1.Lesson.createLesson("mat101",6);
        Gun34.tasks.task1.Lesson fiz101= Gun34.tasks.task1.Lesson.createLesson("fiz101",4);
        Gun34.tasks.task1.Lesson java101= Lesson.createLesson("java101",6);

        Gun34.tasks.task1.Student mehmet= Gun34.tasks.task1.Student.createStudent("Mehmet",20);
        Gun34.tasks.task1.Student ayse= Student.createStudent("Ayşe",12);
