...
public class Soru1 {
    public static void main(String[] args) {
        ...
        // Girilen 2 kelimelik  ad ve soyadlarin ilk harflerinin
        ...
        // tamAd = tamAd.trim(); // bu komut basta ve sondaki bosluklari alir.

        // char ilkBuyukHarf = 'A'; // Sayisal karsiligi 65
        // char ilkKucukHarf = 'a'; // Sayisal karsiligi 97

        int boslukIndex = tamAd.indexOf(" ");
        String ilkHarf = tamAd.substring(0,1).toLowerCase();  // a  yani ilk harfi veriyor
