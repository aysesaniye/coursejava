...
// 4-Düzeltme
// 5-Çıkış
// Seçeneklerini vererek username, password ve userTipi(mudur,calisan) dan oluşan bir Map tanımlayınız.
...
// Bölüm bölüm gidiyoruz önce mainin içini tasarlayınız.
            ...
            public static void main(String[] args) {
                ...
                public static void duzeltme(Map<String,Map<String,String>> users)
                {
                    ...
                    System.out.println("yeni pass giriniz:");
                    String yenipass=scr.nextLine();

                    System.out.println("yeni user tip giriniz:");
